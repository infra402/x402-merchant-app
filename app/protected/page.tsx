export default function ProtectedPage() {
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: '#0B0B10' }}>
      <div className="max-w-2xl mx-auto p-8">
        <h1 className="text-4xl font-bold mb-4" style={{ fontFamily: 'Geist Sans, sans-serif', color: '#E8ECF1' }}>Protected Content</h1>
        <p className="text-lg mb-6" style={{ fontFamily: 'Geist Sans, sans-serif', color: '#9AA4B2' }}>
